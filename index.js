...
function toStdOutAsJson (output) {
...
function elt (eltType, numargs) {
  return function () {
    ...
    var len = args.length
    if (len !== numargs) { throw Error(eltType + ' expects ' + numargs + ' arguments, but given ' + len) }
